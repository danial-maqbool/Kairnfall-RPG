...
public partial class ClientAudio : Node
{
    ...
    /// <summary>Call before tree shutdown so the audio server can process the stop commands.</summary>
    public void ReleasePlayback()
    {
        ...
        // ResourceLoader assets can have other owners. Do not dispose shared resources.
