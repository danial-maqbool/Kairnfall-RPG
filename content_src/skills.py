...
CLASSES = [
 ('vanguard','Vanguard','Defensive melee','Resolve — blocking or weathering hostile pressure builds Resolve. At 50 Resolve, a native shield, taunt, or defensive buff hardens your guard.','copper_sword','linen_heavy_chest',['swordsmanship','shield_mastery','heavy_armor'],{'strength':13,'dexterity':8,'intellect':7,'vitality':15,'spirit':8,'resolve':15,'luck':5}),
 ('berserker','Berserker','Risk-based melee','Fury — dealing and taking damage builds Fury. Basic attacks scale with stored Fury; at 40 Fury, a native offensive ability consumes it for a stronger burst.','copper_greataxe','linen_medium_chest',['axe_mastery','mace_mastery','endurance'],{'strength':17,'dexterity':10,'intellect':5,'vitality':14,'spirit':6,'resolve':10,'luck':5}),
 ('ranger','Ranger','Ranged physical','Focus — damaging threats from range builds Focus. At 40 Focus, a native offensive technique hits harder and refunds stamina.','copper_bow','linen_medium_chest',['archery','crossbow_mastery','hunting'],{'strength':10,'dexterity':17,'intellect':8,'vitality':10,'spirit':9,'resolve':8,'luck':7}),
 ('rogue','Rogue','Ambush and mobility','Momentum — close attacks, evasions, and combat mobility build Momentum. Stealth empowers an opener; at 40 Momentum, a native offensive technique creates a stronger opening.','copper_dagger','linen_light_chest',['dagger_mastery','evasion','lockpicking'],{'strength':10,'dexterity':18,'intellect':9,'vitality':9,'spirit':7,'resolve':8,'luck':8}),
 ('arcanist','Arcanist','Elemental caster','Resonance — elemental spell damage builds Resonance. At 60 Resonance, a native offensive spell consumes it for amplified power and a partial mana refund.','copper_staff','linen_light_chest',['pyromancy','cryomancy','arcane_magic'],{'strength':5,'dexterity':9,'intellect':19,'vitality':9,'spirit':14,'resolve':8,'luck':5}),
 ('warden','Warden','Nature and companions','Bond — Nature, companion, and active support play builds Bond. At 50 Bond, a native heal, ward, cleanse, or summon strengthens the living bond.','copper_staff','linen_medium_chest',['nature_magic','summoning','animal_handling'],{'strength':9,'dexterity':10,'intellect':14,'vitality':11,'spirit':16,'resolve':9,'luck':5}),
 ('templar','Templar','Healing and support','Conviction — healing, protection, and Radiant damage build Conviction. At 50 Conviction, a native Radiant attack consumes it for a stronger judgment and protective aegis.','copper_mace','linen_heavy_chest',['radiance','restoration','shield_mastery'],{'strength':12,'dexterity':7,'intellect':11,'vitality':13,'spirit':16,'resolve':13,'luck':5}),
 ('spellblade','Spellblade','Melee and magic','Spellweave — alternate martial and magical damage to build Spellweave quickly. At 50 Spellweave, an opposite-form native attack consumes it for a stronger weave.','copper_sword','linen_medium_chest',['swordsmanship','arcane_magic','runecasting'],{'strength':13,'dexterity':12,'intellect':14,'vitality':10,'spirit':10,'resolve':9,'luck':5})
]
